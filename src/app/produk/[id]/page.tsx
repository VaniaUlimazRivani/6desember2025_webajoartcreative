...
import { Star, ShoppingBag, ShieldCheck, ArrowLeft, Send } from 'lucide-react';
...
export default function ProductDetail() {
  ...
  const handleSubmitReview = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    setTimeout(() => {
      alert(
        `Terima kasih ${reviewForm.name}! Ulasan Anda telah terkirim dan menunggu persetujuan Admin.`
      );
    ...
    return (
      <div className="min-h-screen bg-[#FDFCF5] flex items-center justify-center font-sans">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-[#4A403A]">
            Produk Tidak Ditemukan
          </h2>
          <Link
            href="/katalog"
            className="text-[#C87941] hover:underline mt-4 block"
          >
            Kembali ke Katalog
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF5] font-sans">
      <div className="pt-32 pb-16 px-4 max-w-6xl mx-auto min-h-screen">
        <Link
          href="/katalog"
          className="mb-8 flex items-center gap-2 font-medium text-gray-500 hover:text-[#C87941] w-fit transition"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 mb-20">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4 leading-tight text-[#4A403A]">
              {product.name}
            </h1>
            ...
            <div className="space-y-6 mb-10">
              <div>
                ...
                <p className="text-gray-600 leading-relaxed text-lg">
                  {product.desc} Mahakarya pengrajin Ajo Art yang menggabungkan
                  fungsi dan estetika. Tekstur unik pada permukaan paralon
                  dihasilkan melalui teknik pembakaran presisi.
                </p>
              </div>
            ...
            <div className="mt-auto pt-6">
              <button
                onClick={() =>
                  window.open(
                    `https://wa.me/6281236007061?text=Halo Ajo Art, saya tertarik dengan produk ${product.name}`,
                    '_blank'
                  )
                }
              ...
              <p className="text-center text-xs text-gray-400 mt-4">
                Transaksi aman dan langsung terhubung dengan pengrajin.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-[#E6D5B8] pt-12 mt-12">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-serif font-bold text-[#4A403A] text-center mb-2">
              Ulasan Pembeli
            </h2>
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl border border-[#E6D5B8] shadow-sm">
              <form onSubmit={handleSubmitReview} className="space-y-5">
                {/* Nama */}
                <div>
                  <label className="block text-sm font-bold text-[#4A403A] mb-2">
                    Nama Lengkap
                  </label>
                  <input
                    type="text"
